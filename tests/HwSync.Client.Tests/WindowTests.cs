...
namespace HwSync.Client.Tests
{
    public class WindowTests
    {
        ...
        {
            using MainViewModel model = new(address => new PreviewClient(), new StubSnapshotProvider()) { ClientRootPath = @"D:\client-folder", RootPath = @"D:\Data\Documents" };
            model.LoadProfiles([new HwSync.Client.Windows.Configuration.SyncProfile { Name = "Тестовый профиль", ServerRootPath = model.RootPath, ClientRootPath = model.ClientRootPath }]);
