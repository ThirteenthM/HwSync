...
namespace HwSync.Windows.AppServices.Client.Diagnostics
{
    /// <summary>
    ...
    public sealed class TransferMetrics : ITransferMetrics
    {
        ...
        public double MegabytesPerSecond => Duration.TotalSeconds > 0
            ? _confirmedBytes / 1_000_000d / Duration.TotalSeconds : 0;
        ...
        public string Describe() =>
            $"{Direction}: файлов {_completedFiles}, {_confirmedBytes / 1_000_000d:F2} МБ; " +
            $"{Duration.TotalSeconds:F2} с; средняя скорость {MegabytesPerSecond:F2} МБ/с.";
    }
}
