...
namespace HwSync.Client.Windows.Application.ViewModels
{
    ...
    public sealed partial class MainViewModel : ObservableObject, IMainViewModel
    {
        ...
        HwSync.Client.Windows.Contract.Diagnostics.ITransferMetrics? IMainViewModel.TransferMetrics => TransferMetrics;

        System.Windows.Input.ICommand IMainViewModel.AutoSyncCommand => AutoSyncCommand;

        private readonly HwSync.Client.Windows.Contract.Services.ISyncDecisionService _decisions;
        ...
        public MainViewModel(Func<Uri, IHwSyncApiClient> createClient, IFileSnapshotProvider snapshotProvider,
            IComparedFileOperations fileOperations, ISourceFileReader fileReader, IMissingFileSynchronizer synchronizer, HwSync.Client.Windows.Contract.Services.ISyncDecisionService decisions)
        {
