...
{
    /// <summary>Маршруты сравнения папок и ручных файловых операций.</summary>
    [ApiController]
    ...
    public sealed class ScanJobsController : ControllerBase
    {
        ...
        /// <summary>Принимает обработчик запросов к заданиям.</summary>
        public ScanJobsController(ScanJobHandler handler)
        {
            _handler = handler;
        }

        /// <summary>Передаёт поток запроса обработчику загрузки файла.</summary>
        ...
        /// <summary>Передаёт обработчику запрос удаления серверного файла.</summary>
        ...
        /// <summary>Проверяет отсутствие серверной копии перед удалением на клиенте.</summary>
        ...
        /// <summary>Возвращает отметки удаления файлов папки.</summary>
